...
|-------|-------------|------------|------|-------------|--------|
| all | All tools in one image | all components | 340.2 MB | `docker pull toolkitbox/all` | [![Docker Pulls](https://img.shields.io/docker/pulls/toolkitbox/all?logo=docker)](https://hub.docker.com/r/toolkitbox/all) |
| cloud | Cloud Bundle | aws-cli, azure-cli, gcloud | 280.7 MB | `docker pull toolkitbox/cloud` | [![Docker Pulls](https://img.shields.io/docker/pulls/toolkitbox/cloud?logo=docker)](https://hub.docker.com/r/toolkitbox/cloud) |
